...
#define fprintf(...) __android_log_print(ANDROID_LOG_ERROR, "suncoin", _va_rest(__VA_ARGS__, NULL))
#define printf(...) __android_log_print(ANDROID_LOG_INFO, "suncoin", __VA_ARGS__)
