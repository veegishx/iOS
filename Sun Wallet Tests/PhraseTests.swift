...
class PhraseTests: XCTestCase {
    ...
    func testInvalidPhrase() {
        XCTAssertFalse(walletManager.isPhraseValid("This is totally and absolutely an invalid bip 39 sunwallet recovery phrase"), "Invalid phrase should not be valid")
    }
